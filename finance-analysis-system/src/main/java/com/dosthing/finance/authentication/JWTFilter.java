package com.dosthing.finance.authentication;


import com.dosthing.finance.properties.SystemProperties;
import com.dosthing.finance.utils.SpringContextUtil;
...
public class JWTFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) throws UnauthorizedException {
        ...
        log.info("jwtfilter 收到请求: "+httpServletRequest.getRequestURI());
        //暂时放开限制
